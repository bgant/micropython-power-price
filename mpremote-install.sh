...
mpremote $TTY mip install --target= github:bgant/micropython/modules/ping_check.py
mpremote $TTY mip install --target= github:bgant/micropython/modules/uping.py
